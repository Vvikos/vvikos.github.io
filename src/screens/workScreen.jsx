...
export default function WorkScreen({mainRef}) {
	...
	const projects = [
		{name: 'My Portfolio', img: PF, desc: 'Design and implement my current portfolio that you\'re reading.', role: 'Front End', techno: ['React.js', 'CSS', 'HTML', 'Javasript'], tags: ['Personal'], duration: '2 months', people: 1},
		...
		{name: 'RinVR', img: VR, desc: 'WebVR application that immerses people into a graphical editor for R language to interact with data with a low knowledge in the language.', role: 'Front End', techno: ['Three.js', 'React-XR', 'react-three/drei'], tags: ['Scholar', 'Research'], duration: '1 year', people: 5},
		{name: 'MediaHub', img: MH, desc: 'Mobile application to manage all your series, movies and TV shows lecture and favorites.', role: 'Front End', techno: ['React Native'], tags: ['Scholar'], duration: '3 months', people: 5},
		{name: 'ERP System', img: ERP, desc: 'Implements application to manage your account as a student for a 4-parts ERP application for the University of Strasbourg.', role: 'Fullstack', techno: ['React.js', 'Node.js'], tags: ['Scholar', 'ERP'], duration: '3 months', people: 15},
		{name: 'ApolloOptionsPicker', img: AOP, desc: 'Application that allows to choose graphically compilation settings for Automatic speculative POLyhedral Loop Optimizer Apollo.', role: 'Front End', techno: ['C++', 'Qt'], tags: ['Scholar', 'Research'], duration: '6 months', people: 1},
